...
$where =" st.ticket_status IN('$status') AND sa.appointment_status='ASSIGNED' ";
$year=$_REQUEST['year'];
...
echo json_encode(
    SSP::complainAssignedListEcecutive($_REQUEST, $sql_details, $table, $primaryKey, $columns,$where)
);

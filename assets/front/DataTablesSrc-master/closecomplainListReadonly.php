...
$mobile=$_REQUEST['monumber'];
//$uploaded_file_tag=$_REQUEST['uploaded_file_tag'];
//
//
$where.=" AND customer_mobile_number=$mobile ";
...
echo json_encode(
    SSP::complainListReadonly($_REQUEST, $sql_details, $table, $primaryKey, $columns,$where)
);

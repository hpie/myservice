    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-12">                                
                 <div class="job-list">
                    <div class="thumb">
                        <a href="#"><img src="<?php echo CLIENT_ASSETS; ?>img/jobs/img-1.jpg" alt=""></a>
                    </div>
                    <div class="job-list-content">
                        <h4><a href="#">Compain Title</a><span class="full-time">Full-Time</span></h4>
                        ...
                        <div class="job-tag">
                            ...
                            <div class="pull-right">                                
                                <div class="icon">
                                    <i class="ti-heart add-fav" data-type="fav" data-id=""></i>
                                </div>
                                <div class="icon" style="display:none" >
                                    <i class="fa fa-heart add-fav" data-type="unfav" data-id=""></i>
                                </div>                                
                                <div class="icon" >
                                    <i class="fa fa-heart add-fav" data-type="unfav" data-id=""></i>
                                </div>
            ...
            <div class="col-md-12">
                <div class="showing pull-left">
                    <a href="#">Showing <span>1</span> Of 10 Jobs</a>
                </div>                    
